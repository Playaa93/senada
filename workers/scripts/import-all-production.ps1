...
Write-Host "============================================================"
Write-Host "Importing 70,103 fragrances to D1 PRODUCTION database"
...
foreach ($file in $files) {
    ...
    # Execute wrangler command with --remote flag for production
    $result = npx wrangler d1 execute senada-db --remote --file="$($file.FullName)" 2>&1
...
Write-Host "Verifying production import..."
